...
If you only want to install Graphiql to run queries, you can go to [`electronjs.org`](https://electronjs.org/apps/graphiql) and click the download button to get an executable installation file.
